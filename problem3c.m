...
for i = 1:size(alpha,2)
    ...
    Listmean_BG{i} =  covariance*inv(covariance+D1variance_BG/BGn)*D1mean_BG' + D1variance_BG/BGn*inv(covariance+D1variance_BG/BGn)'* mu0_BG';
    Listmean_FG{i} =  covariance*inv(covariance+D1variance_FG/FGn)*D1mean_FG' + D1variance_FG/FGn*inv(covariance+D1variance_FG/FGn)'* mu0_FG';
end
